...
local shard artifacts only. It does not require or access any downstream DB,
payment provider, deploy provider, service role, or production secret.
"""
...
def analyze_detail(page_html: str) -> tuple[list[dict[str, str]], list[dict[str, str]]]:
...
def run_self_test() -> None:
    ...
    """
    summary, tables = analyze_detail(sample)
...
def process_candidate(
    *,
    ...
    try:
        ...
        section_summaries, section_tables = analyze_detail(page_html)
        summary_rows: list[dict[str, str]] = []
        table_rows: list[dict[str, str]] = []
